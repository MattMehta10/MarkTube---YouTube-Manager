  ...
  return (
    <div
      className={`bg-gradient-to-tr transition-all duration-500 ease-in-out from-70% from-transparent to-85% ${bg(
        type
      )} relative hover:w-114 border-2 border-gray-500/30 w-112 whitespace-pre-wrap aspect-video flex gap-5 items-start rounded-2xl h-20 text-white cursor-pointer`}
    >
      <div className="w-[30%]">
        <img
          src={data.thumbnail || 'https://via.placeholder.com/110x60'}
          alt={data.title}
      ...
      <div className="w-[60%]">
        <div className="mt-2 flex flex-col justify-start">
          ...
          <div>
            <p className="text-[13px] mt-1 flex items-center gap-2 text-gray-300">
              {data.channel}
            </p>
          </div>
        </div>
